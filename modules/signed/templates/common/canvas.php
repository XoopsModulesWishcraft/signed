 ...
 */
	...
	signedCanvas::getInstance()->addScript(XOOPS_URL . '/browse.php?Frameworks/jquery/jquery.js',  array("type"=>"text/javascript"));
		...
		<div id="footer">
			...
			<strong><a href="/modules/signed/docs">System Documentation</a>&nbsp;|&nbsp;<a target="_blank" href="<?php echo _URL_API; ?>"><?php echo sprintf(_CONTENT_API_TITLE, _SIGNED_API_VERSION); ?></a><br/><br>
