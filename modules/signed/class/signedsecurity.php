...
class signedSecurity extends XoopsSecurity
{
    ...
    {
    	return signedArrays::getInstance()->trimExplode(file(_PATH_PROCESSES . DIRECTORY_SEPARATOR . 'banned-hostnames-for-urls-and-emails.txt'));
    }
    ...
    {
    	return signedArrays::getInstance()->trimExplode(file(_PATH_PROCESSES . DIRECTORY_SEPARATOR . 'banned-ips-for-urls-and-emails.txt'));
    }
